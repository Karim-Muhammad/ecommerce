...
Line 16:4 Transforming class syntax to the configured target environment ("es5") is not supported yet
...
Line 49:12 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 57:23 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 71:19 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 109:15 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 115:17 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 139:19 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
